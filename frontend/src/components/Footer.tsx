  ...
  return (
    <footer className="relative w-full mb-20 mt-20">
      <div className="w-full px-8 mx-auto max-w-7xl">
        {/* Footer Grid */}
        <div className="flex flex-col items-center md:items-start  gap-6 md:flex-row md:justify-between">
          {/* Logo & Description */}
          ...
          {/* Company Links */}
          <div >
            <p className="mb-1  text-base font-semibold text-slate-800 hidden  md:flex ">Company</p>
          ...
          {/* Contact Info */}
          <div>
            <p className="mb-1 text-base font-semibold text-slate-800 hidden  md:flex">GET IN TOUCH</p>
            <ul className="flex gap-4  justify-center md:flex-col md:gap-0 ">
              <li>
